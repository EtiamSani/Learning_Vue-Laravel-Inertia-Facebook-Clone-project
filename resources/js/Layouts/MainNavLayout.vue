    ...
    >
        <div id="NavLeft" class="flex items-center justify-start w-[260px]">
            ...
            >
                ...
                <input
                    class="lg:block hidden border-none p-0 bg-[#EFF2F5] placeholder-[#64676B]"
                    placeholder="Chercher Facebook"
                    type="text"
                />
            </div>
        </div>
        ...
        <div
            id="NavCenter"
            class="hidden lg:flex items-center ml-5 justify-center w-8/12 maw-w-[600px]"
        >
